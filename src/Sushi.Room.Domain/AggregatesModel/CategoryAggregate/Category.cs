...
namespace Sushi.Room.Domain.AggregatesModel.CategoryAggregate
{
    public class Category : Entity, IAggregateRoot
    {
        ...
        private Category(string caption, string captionEng)
        {
            Caption = caption;
        ...
        public static Category CreateNew(string caption, string captionEng, bool isPublished)
        {
            var category = new Category(caption, captionEng);
